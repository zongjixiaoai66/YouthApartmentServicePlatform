    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="所在小区" prop="fangwuXiaoqu">
                       <el-input v-model="ruleForm.fangwuXiaoqu"
                                 placeholder="所在小区" clearable  :readonly="ro.fangwuXiaoqu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="所在小区" prop="fangwuXiaoqu">
                           <el-input v-model="ruleForm.fangwuXiaoqu"
                                     placeholder="所在小区" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="详细地址" prop="fangwuAddress">
                       <el-input v-model="ruleForm.fangwuAddress"
                                 placeholder="详细地址" clearable  :readonly="ro.fangwuAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="详细地址" prop="fangwuAddress">
                           <el-input v-model="ruleForm.fangwuAddress"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="房屋朝向" prop="fangwuChaoxiangTypes">
                        <el-select v-model="ruleForm.fangwuChaoxiangTypes" :disabled="ro.fangwuChaoxiangTypes" placeholder="请选择房屋朝向">
                            <el-option
                                v-for="(item,index) in fangwuChaoxiangTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="房屋朝向" prop="fangwuChaoxiangValue">
                        <el-input v-model="ruleForm.fangwuChaoxiangValue"
                            placeholder="房屋朝向" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="平米" prop="fangwuPingmi">
                       <el-input v-model="ruleForm.fangwuPingmi"
                                 placeholder="平米" clearable  :readonly="ro.fangwuPingmi"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="平米" prop="fangwuPingmi">
                           <el-input v-model="ruleForm.fangwuPingmi"
                                     placeholder="平米" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房屋原价" prop="fangwuOldMoney">
                       <el-input v-model="ruleForm.fangwuOldMoney"
                                 placeholder="房屋原价" clearable  :readonly="ro.fangwuOldMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房屋现价/月" prop="fangwuNewMoney">
                       <el-input v-model="ruleForm.fangwuNewMoney"
                                 placeholder="房屋现价/月" clearable  :readonly="ro.fangwuNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="房屋现价/月" prop="fangwuNewMoney">
                           <el-input v-model="ruleForm.fangwuNewMoney"
                                     placeholder="房屋现价/月" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="房屋详细介绍" prop="fangwuContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.fangwuContent" label="房屋详细介绍" prop="fangwuContent">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   fangwuPingmi: [
                              { required: true, message: '平米不能为空', trigger: 'blur' },
                          ],
                   fangwuOldMoney: [
                              { required: true, message: '房屋原价不能为空', trigger: 'blur' },
                   ...
                   fangwuNewMoney: [
                              { required: true, message: '房屋现价/月不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=fangwu_chaoxiang_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.fangwuChaoxiangTypesOptions = data.data.list;
                    }
                });
                this.$http({
