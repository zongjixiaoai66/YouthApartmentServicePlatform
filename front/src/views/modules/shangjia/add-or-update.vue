        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shangjiaPhoto" label="商家照片" prop="shangjiaPhoto">
                        <file-upload
                            tip="点击上传商家照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangjiaPhoto" label="商家照片" prop="shangjiaPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="账户状态" prop="shangjiaShiyongTypes">
                        <el-select v-model="ruleForm.shangjiaShiyongTypes" :disabled="ro.shangjiaShiyongTypes" placeholder="请选择账户状态">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="账户状态" prop="shangjiaShiyongValue">
                        <el-input v-model="ruleForm.shangjiaShiyongValue"
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangjiaPhoto: [
                              { required: true, message: '商家照片不能为空', trigger: 'blur' },
                          ],
                   shangjiaXingjiTypes: [
