    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="看房编号" prop="fangwuOrderUuidNumber">
                       <el-input v-model="ruleForm.fangwuOrderUuidNumber"
                                 placeholder="看房编号" clearable  :readonly="ro.fangwuOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="看房编号" prop="fangwuOrderUuidNumber">
                           <el-input v-model="ruleForm.fangwuOrderUuidNumber"
                                     placeholder="看房编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="申请看房时间" prop="yuyueTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yuyueTime" label="申请看房时间" prop="yuyueTime">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.fangwuOrderYesnoTypes" label="预约状态" prop="fangwuOrderYesnoTypes">
                        <el-input v-model="ruleForm.fangwuOrderYesnoValue" placeholder="预约状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.fangwuOrderYesnoText" label="审核意见" prop="fangwuOrderYesnoText">
                        <span v-html="ruleForm.fangwuOrderYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.fangwuOrderShenheTime" label="审核时间" prop="fangwuOrderShenheTime">
                        <span v-html="ruleForm.fangwuOrderShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    insertTime: false,
                    yuyueTime: false,
                    fangwuOrderYesnoTypes: false,
                    fangwuOrderYesnoText: false,
                    fangwuOrderShenheTime: false,
                },
                ruleForm: {
                    ...
                    insertTime: '',
                    yuyueTime: '',
                    fangwuOrderYesnoTypes: '',
                    fangwuOrderYesnoText: '',
                    fangwuOrderShenheTime: '',
                },
                fangwuOrderYesnoTypesOptions : [],
                fangwuOptions : [],
                yonghuOptions : [],
                rules: {
                   fangwuOrderUuidNumber: [
                              { required: true, message: '看房编号不能为空', trigger: 'blur' },
                          ],
                   fangwuId: [
                   ...
                   yuyueTime: [
                              { required: true, message: '申请看房时间不能为空', trigger: 'blur' },
                          ],
                   fangwuOrderYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=fangwu_order_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.fangwuOrderYesnoTypesOptions = data.data.list;
                    }
                });
