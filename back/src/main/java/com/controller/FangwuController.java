    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(fangwu !=null){
            ...
            BeanUtils.copyProperties( fangwu , view );//把实体数据重构到view中
                ...
                //级联表
                ShangjiaEntity shangjia = shangjiaService.selectById(fangwu.getShangjiaId());
                if(shangjia != null){
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            FangwuEntity fangwuEntity = new FangwuEntity();
//                            fangwuEntity.setShangjiaId(Integer.valueOf(data.get(0)));   //商家 要改的
...
//                            fangwuEntity.setFangwuXiaoqu(data.get(0));                    //所在小区 要改的
//                            fangwuEntity.setFangwuAddress(data.get(0));                    //详细地址 要改的
//                            fangwuEntity.setFangwuTypes(Integer.valueOf(data.get(0)));   //房屋类型 要改的
//                            fangwuEntity.setFangwuChaoxiangTypes(Integer.valueOf(data.get(0)));   //房屋朝向 要改的
//                            fangwuEntity.setFangwuPingmi(data.get(0));                    //平米 要改的
//                            fangwuEntity.setFangwuOldMoney(data.get(0));                    //房屋原价 要改的
//                            fangwuEntity.setFangwuNewMoney(data.get(0));                    //房屋现价/月 要改的
